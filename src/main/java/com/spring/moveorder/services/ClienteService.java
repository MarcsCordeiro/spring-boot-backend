...
public class ClienteService {
	...
	public Cliente update(Cliente obj) {
		Cliente newObj = find(obj.getId());//Atualiza trazendo todos os atributos
	...
	public void delete(Integer id) {
		...
		repo.deleteById(id);
			...
			throw new DataIntegrityException("Não é possivel excluir por ter entidades relacionadas.");
		}
	}
